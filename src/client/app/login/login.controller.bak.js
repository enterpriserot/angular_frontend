(function() {
    ...
    LoginController.$inject = ['dataservice', '$state', 'routerHelper', '$uibModalInstance', '$timeout', 'logger', '$rootScope'/*, 'cookiesService'*/];

    /* @ngInject */
    function LoginController(dataservice, $state, routerHelper, $uibModalInstance, $timeout, logger, $rootScope/*, cookiesService*/) {
        var vm = this;
        vm.title = 'Login';
