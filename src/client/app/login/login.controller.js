(function() {
  ...
  LoginController.$inject = ['dataservice','$http', '$state', 'routerHelper',
  '$uibModalInstance', '$timeout', 'logger', '$rootScope', '$location'];

  /* @ngInject */
  function LoginController(dataservice, $http, $state, routerHelper, $uibModalInstance, $timeout,
